...
import FoodCollectCard from '@/components/FoodCollectCard/index.vue'
...
<template>
  <BasePage>
    ...
    <view class="eat">
      <view class="tip-card">
        <image class="tip-card__icon" src="/static/brand/fluent-wheat.png" mode="aspectFit" />
        <view class="tip-card__text">
          <text class="tip-card__title">吃饭小默契</text>
          <text class="tip-card__desc">说好的，一起吃饭尽量不浪费。</text>
        </view>
      </view>

      <view class="progress">
        <view class="progress__row">
          <text class="progress__label">美食收集进度</text>
          <text class="progress__count">已吃过 {{ visitedCount }} / {{ totalCount }}</text>
        </view>
